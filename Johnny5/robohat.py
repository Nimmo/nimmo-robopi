...
# Servo Functions
#
# setServo(Degrees). Sets the servo to position in degrees -90 to +90
#======================================================================
...
# =====================================================================
# Servo Functions
# Pirocon/Microcon/RoboHAT use PWM to control servos


def setServo(Degrees):
    #print(pin, degrees)
    if -90 < Degrees < 90:
        direction = int(30 + (Degrees / 4.5))
        s.ChangeDutyCycle(direction)
    else:
        print("Angle must be between -90 and 90")
